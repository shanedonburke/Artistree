...
export class CanvasTool extends React.Component {
    render() {
        return (
            <div className="tool-button" style={{ backgroundColor: this.props.selectedIcon === this.props.toolName ? '#918e8e' : null }} onClick={() => this.props.onSelect(this.props.toolName)}>
                { this.props.toolName }
